...
// of led register, write the new value to turn led on
// display the new value, sleep for 2 second and 
// write a value to turn led off
...
int main()
{
	...
	fd = open("/dev/part32_0", O_RDWR); //open the file
